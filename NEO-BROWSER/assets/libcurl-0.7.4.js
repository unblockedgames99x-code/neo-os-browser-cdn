/* NEO BROWSER: libcurl.js@0.7.4 vendored locally (originally distributed through jsDelivr).
   Self-contained boot: works with only WISP reachable, and pins the version
   so @latest can never change out from under us. */
/*
...
function load_wasm(url) {
  ...
  url = url || wasmBinaryFile || locateFile("libcurl-0.7.4.wasm");
